...
@section('title', 'Affichage Avocats')
                ...
                <div class="{{app()->getLocale() === 'ar' ? 'col-xl-4 col-sm-3':'col-xl-4 col-sm-4'}} mx-1 ">
                    <div class="row justify-content-end">
                        <div class="{{app()->getLocale() === 'ar' ? 'col-xl-6':'col-xl-8'}} rounded-4 " style="border:1px solid rgb(213, 212, 212);height:46.5px" >
                            <a href="{{ route('avocats.create') }}" class="text-dark text-decoration-none fw-bold">
