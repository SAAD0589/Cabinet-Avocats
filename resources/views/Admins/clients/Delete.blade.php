<form action="{{route('DeleteClt')}}" method="post">
    @csrf
    <div class="modal fade" id="DeletedClt" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
          <input type="hidden" value="" name="inputDelete" id="FromClt">
