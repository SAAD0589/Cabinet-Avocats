<form action="{{route('DeleteRendezVous')}}" method="post">
    @csrf
    <div class="modal fade" id="DeletedRendezVous" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
          <input type="hidden" class="FromRendezVous" value="" name="FromRendezVous" >
