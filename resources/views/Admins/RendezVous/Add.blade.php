...
@section('title', 'Ajoute Rendez Vous')
                ...
                <div class="">
                    ...
                    <div class="row py-2 justify-content-center">
                        ...
                        <div class="col-5 py-3">
                            <div class="relative">
                                <input class="inputcheck input-cal input-base  form-control" id="input" placeholder=""
                                    name="DateHeure" type="datetime-local">
                                <label id="label-input" class="fw-bold"
                                    style="font-weight: bold;font-size:18px;{{ app()->getLocale() === 'ar' ? 'right: 10px' : 'left: 10px' }}">
                                    التاريخ
                                </label>
                        ...
                        <div class="col-5 py-2">
                            ...
                            {{ app()->getLocale() === 'ar' ? 'no-repeat 3%' : 'no-repeat 97%' }}  !important;"
                                ...
                                <option value="" disabled selected>الصفة</option>
                                <option value="avocat">محامي</option>
                                <option value="secretary">سكرتار</option>
                            </select>
                            @error('status')
                                <p class="text-end text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-5 py-2">
                            ...
                            {{ app()->getLocale() === 'ar' ? 'no-repeat 3%' : 'no-repeat 97%' }}  !important;"
                                ...
                                @foreach ($avocats as $avocat)
                                    <option value="{{ $avocat->id }}">{{ $avocat->name }}</option>
                                @endforeach
                        ...
                        <div class="col-5 py-3">
                            ...
                            {{ app()->getLocale() === 'ar' ? 'no-repeat 3%' : 'no-repeat 97%' }}  !important;"
                                aria-label="Default select example">
                                <option value="" disabled selected>الموكل</option>
                            </select>
                            @error('conf_email')
                                <p class="text-end text-danger">{{ $message }}</p>
                            @enderror
