...
@section('title', 'Affichage Rendez Vous')
...
@section('content')
    ...
    <div class="container py-5">
            ...
            <div class="row justify-content-between">
                ...
                <div class="{{app()->getLocale() === 'ar' ? 'col-xl-4 col-sm-3':'col-xl-4 col-sm-4'}} mx-1 ">
                    <div class="row justify-content-end">
                        <div class="{{app()->getLocale() === 'ar' ? 'col-xl-6':'col-xl-8'}} rounded-4 " style="border:1px solid rgb(213, 212, 212);height:46.5px" >
                            <a href="{{route('RendezVous.create')}}" class="text-dark text-decoration-none fw-bold">
        ...
        <div class="col-12">
            <livewire:affichage-rendez-vous />
        </div>
         @include('Admins.RendezVous.Truncate')
