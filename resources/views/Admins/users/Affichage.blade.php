    ...
    <div class="container py-5">
        <div class="row ">
            <div class="col-12 d-flex  px-5 py-3">
                <h3 class="py-1 fw-bold" id="">
                    {{ __('content.قائمة المستخدمون') }}
                </h3>
            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-4 col-sm-4 mx-1 ">
                    <div class="row justify-content-end">
                        <div class="{{app()->getLocale() === 'ar' ? 'col-xl-6 col-sm-9':'col-xl-8 col-sm-12'}} rounded-4 " style="border:1px solid rgb(213, 212, 212);height:46.5px" >
                            <a href="{{ route('users.create') }}" class="text-dark text-decoration-none fw-bold">
                                <div class="row d-flex justify-content-between ">
                                    @if (app()->getLocale() === 'ar' )
                                    <div class="col-xl-10 col-sm-9 align-self-center ">
