<form action="{{route('DeleteUser')}}" method="post">
    @csrf
    <div class="modal fade" id="DeletedUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
          <input type="hidden" value="" name="inputDelete" id="FromUser">
