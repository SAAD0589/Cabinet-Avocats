...
@section('content')
    ...
    <div class="container ">
        <div class="d-flex justify-content-between my-1 align-items-center" style="height: 120px">
            <div class="w-100">
                <h3 class="fw-bold text-center px-5 " style="margin-right:90px ">إضافة طلب تبليغي</h3>
            </div>
            <div class="">
                    ...
                    <div class="row py-2 justify-content-center">
                        ...
                        <div class="col-xl-5 col-sm-6 py-2">
                            <input type="text" class="form-control " dir="rtl" placeholder="رقم الملف التبليغي "
                                name="Num_Doc_R" style="font-weight: bold;font-size:18px">
                            @error('Num_Doc_R')
                                <p class="text-end text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-xl-5 col-sm-6 ">
                            ...
                            dir="rtl" placeholder="مرجع الملف" name="dossier_id" style="font-weight: bold;font-size:18px">
                            @error('dossier_id')
                            <p class="text-end text-danger">{{ $message }}</p>
                            @enderror --}}
                        ...
                        <div class="row d-flex justify-content-center py-5">
                            <div class="col-xl-8  ">
                                <div class="row">
                                    <div class="col-6">
                                        <button type="submit" class="add btn text-light w-100 py-2"
                                            style="width:125px;background: #C09F5E;font-weight: bold;font-size:18px">إضافة</button>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{ route('reports.index') }}" class="cancel btn w-100 py-2">إلغاء</a>
                                    </div>
