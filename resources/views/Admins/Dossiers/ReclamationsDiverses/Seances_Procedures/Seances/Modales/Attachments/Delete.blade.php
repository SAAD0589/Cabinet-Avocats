<form action="{{route('deleteAtt')}}" method="post">
    @csrf
    <div class="modal fade" id="DeleteAtt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
          <input type="hidden" name="idatt" id="idatt" value="">
