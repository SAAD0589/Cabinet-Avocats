<div class="my-4">
    ...
    <div class="row">
        <form action="{{ route('UpdateReclamationsDiversesPrimary', $tribunals_dossiers->id) }}" method="post">
            @csrf
            ...
            <div class="row justify-content-center py-5" id="primary">
                ...
                <div class="col-5 py-2">
                    <select class="form-select" id='villes' name="ville" aria-label="Default select example"
                        ...
                        @foreach ($villes as $ville)
                            <option @if ($tribunals_dossiers->ville  == $ville->id) selected @endif 
                            value="{{ $ville->id }}">{{ __('region.' . $ville->ville_nom) }}</option>
                        @endforeach
                    </select>
                    @error('ville')
                ...
                <div class="col-5 py-2">
                    ...
                    <select class="form-select" name="tribunal_id" id="tribunal" aria-label="Default select example"
                        ...
                        <option value="" disabled>{{ __('content.المحكمة') }}</option>
                        <option selected value="{{$tribunal->id}}">{{$tribunal->trib_nom}}</option>
                    </select>
                    @error('tribunal_id')
                ...
                <div class="col-5 py-3">
                    <select class="form-select" name="type_dossier" aria-label="Default select example"
                        ...
                        @foreach ($typeDossiers as $typeDossier)
                            <option @if ($tribunals_dossiers->type_dossier  == $typeDossier->id) selected @endif 
                            value="{{ $typeDossier->id }}">
                ...
                <div class="col-5 py-3">
                    <div class="relative">
                        ...
                        type="text" name="reference_trib" value="{{$tribunals_dossiers->reference_trib}}">
                ...
                <div class="col-5 py-2">
                    ...
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="juge" value="{{$tribunals_dossiers->juge}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                ...
                <div class="col-5 py-2">
                    ...
                    <select class="form-select" aria-label="Default select example" name="sale_num"
                        ...
                        @for ($i = 1; $i <= 50; $i++)
                            <option @if ($tribunals_dossiers->sale_num == $i) selected @endif 
                             value="{{ $i }}">{{ $i }}</option>
                        @endfor
                    </select>
                    @error('sale_num')
                ...
                <div class="col-5 py-2">
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="heure" value="{{$tribunals_dossiers->heure}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                ...
                <div class="col-5 py-2">
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="date_jugement" value="{{$tribunals_dossiers->date_jugement}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                ...
                <div class="col-5 py-2">
                    ...
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="jugement" value="{{$tribunals_dossiers->jugement}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                ...
                <div class="col-5 py-3">
                    ...
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="prejudice" value="{{$tribunals_dossiers->prejudice}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                ...
                <div class="col-5">
                    <div class="row ">
                        ...
                        <div class="col-11  fw-bold  ">
                            <input type="radio" onclick="classDisp()" checked value="yes" name="check"
                            value="yes">
        ...
        <form action="{{ route('UpdateReclamationsDiversesApel', $tribunals_dossiers->id) }}" method="post">
            @csrf
            <div class="row justify-content-center py-5 " id="apel" style="display: none">
                  <div class="col-5 py-3">
                    ...
                    <select class="form-select" name="tribunal_id" aria-label="Default select example"
                      style="font-weight: bold;font-size:18px">
                    <option value="" disabled>{{ __('content.المحكمة الإستئنافية') }}</option>
                    @foreach ($tribunalsApels as $tribunalsApel)
                        <option @if ($tribunals_dossiers->tribunal_id   == $tribunalsApel->id) selected @endif 
                        value="{{ $tribunalsApel->id }}">{{$tribunalsApel->trib_nom }}</option>
                    @endforeach
                </select>
        ...
        <form action="{{ route('UpdateReclamationsDiversesCas', $tribunals_dossiers->id) }}" method="post">
            @csrf
            <div class="row justify-content-center py-5" id="cas" style="display: none">
                ...
                <div class="col-xl-5 py-2 col-sm-10">
                 ...
                 <div class="col-xl-5 col-sm-10 py-2">
                    <div class="relative">
                        <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" 
                        type="text" name="date_dec" value="{{$tribunals_dossiers->date_dec}}">
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
                            {{ app()->getLocale() === 'ar' ? 'right: 10px' : 'left: 10px' }}">{{ __('content.تاريخ القرار') }}</label>
                    </div>
        ...
        <form action="{{ route('UpdateReclamationsDiversesObservation', $dossier->id) }}" method="post">
            @csrf
            <div class="row py-5 px-5" id="comment" style="display: none">
                ...
                <div class="col-11">
                    ...
                    <div class="relative">
                        <textarea name="observation" class="inputcheck input-cal input-base  form-control" id="input" placeholder="" type="text">{{$dossier->observation}}</textarea>
                        <label id="label-input" class="fw-bold"
                            style="font-weight: bold;font-size:18px;
