...
@section('content')
    ...
    <form action="{{ route('UpdateReclamationsDiversesForm1', $dossier->id) }}" method="post" id="FormOne" class="my-4">
        @csrf
        <div>
            ...
            <div class="row d-flex ">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-5 py-2">
                        ...
                        <div class="relative">
                            <input class="inputcheck input-cal input-base  form-control" id="input" placeholder=""
                                type="text" name="Adversaire" value="{{ $dossier->Adversaire }}">
                            <label id="label-input" class="fw-bold"
                                style="font-weight: bold;font-size:18px;
                    ...
                    <div class="col-5 py-2">
                        <div class="relative">
                            <input class="inputcheck input-cal input-base  form-control" id="input" placeholder=""
                                type="text" name="avocat_Adversaire"  value="{{ $dossier->avocat_Adversaire }}">
                            <label id="label-input" class="fw-bold"
                                style="font-weight: bold;font-size:18px;
                    ...
                    <div class="col-5 py-2">
                        ...
                        <div class="relative">
                            <input class="inputcheck input-cal input-base  form-control" id="input" placeholder=""
                                type="text" name="Adresse_Adversaire" value="{{ $dossier->Adresse_Adversaire }}">
                            <label id="label-input" class="fw-bold"
                                style="font-weight: bold;font-size:18px;
    ...
    <div style="display: none" id="FormTwo">
        @include('Admins.Dossiers.ReclamationsDiverses.Plus.Updates.Form2')
    </div>
    <script>
