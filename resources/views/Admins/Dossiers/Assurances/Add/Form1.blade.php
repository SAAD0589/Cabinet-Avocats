...
@section('title', 'Ajoute Assurance')
...
@section('content')
    ...
    <form action="{{ route('assuranceForm1') }}" method="post">
        @csrf
        <div>
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="row d-flex justify-content-center py-5">
                        <div class="col-8  ">
                            <div class="row">
                                <div class="col-6">
                                    <button type="submit" wire:click='next1'
                                        class="btn text-light w-100 py-2 text-capitalize"
