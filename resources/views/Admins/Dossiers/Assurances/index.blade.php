...
@section('title', 'Affichage Assurances')
...
@section('content')
    ...
    <div class="container  py-5 px-5">
        <div class="row justify-content-between">
            ...
            <div class=" {{ app()->getLocale() === 'ar' ? 'col-xl-8 col-sm-6' : 'col-xl-8 col-sm-7' }}">
                <div class="row justify-content-between">
                ...
                <div class="{{ app()->getLocale() === 'ar' ? 'col-xl-4 col-sm-6 ' : 'col-xl-4 col-sm-5' }}">
                  <div class="row justify-content-end">
                  <div class="{{ app()->getLocale() === 'ar' ? 'col-xl-8 col-sm-6 px-3' : 'col-xl-8 col-sm-10' }}    rounded-3 mx-3 "
                    style="border:1px solid rgb(213, 212, 212);height:46.5px">
                    <a href="{{route('assurances.create')}}" class="text-dark text-decoration-none fw-bold">
