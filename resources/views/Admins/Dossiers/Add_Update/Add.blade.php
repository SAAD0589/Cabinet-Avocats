...
<div class="row d-flex ">
    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-5 py-3">
            <div class="relative">
                <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" type="text" name="id_clt_enmy">
                <label id="label-input" class="fw-bold"
                    style="font-weight: bold;font-size:18px;
        ...
        <div class="col-5 py-2">
            ...
            <div class="relative">
                <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" type="text" name="avocat_enmy">
                <label id="label-input" class="fw-bold"
                    style="font-weight: bold;font-size:18px;
        ...
        <div class="col-5 py-2">
            <div class="relative">
                <input class="inputcheck input-cal input-base  form-control" id="input" placeholder="" type="text">
                <label id="label-input" class="fw-bold"
                    style="font-weight: bold;font-size:18px;
