...
@section('content')
    ...
    <div class="container ">
        <div class="d-flex justify-content-between my-1 align-items-center" style="height: 120px">
            ...
            <div class="w-100">
                <h3 class="fw-bold text-center px-5 " style="margin-right:90px ">تعديل طلب تنفيذي</h3>
            </div>
            <div class="">
        ...
        <div class="row d-flex justify-content-end">
            <form action="{{ route('implementations.update', $implementation->id) }}" method="post"
                    ...
                    <div class="row py-2 justify-content-center">
                        ...
                        <div class="col-5 py-2">
                            <input type="text" class="form-control " dir="rtl" placeholder="رقم الملف التبليغي "
                                ...
                                value="{{ $implementation->folder_implentaire_num }}">
                        ...
                        <div class="col-5 ">
                            <select class="form-select" aria-label="Default select example" id="id_clt"
                                ...
                                @foreach ($ImpChecks as $ImpCheck)
                                    <option value="{{ $ImpCheck->id }}">{{ $ImpCheck->reference }} /
                                        {{ $ImpCheck->type_nom }} </option>
                                @endforeach
                        ...
                        <div class="col-5 py-2">
                            <input type="text" class="form-control " dir="rtl" placeholder="اسم المفوض القضائي"
                                ...
                                value="{{ $implementation->implementation_num }}">
                        ...
                        <div class="col-5 py-2 ">
                            <input type="text" class="form-control " dir="rtl" placeholder="رقم الملف"
                                ...
                                value="{{ $implementation->trib_reference }}">
                        ...
                        <div class="row d-flex justify-content-center py-5">
                            <div class="col-8  ">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('implementations.index') }}" class="btn w-100 py-2"
