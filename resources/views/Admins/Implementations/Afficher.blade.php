    ...
    <div class="container  py-5">
        <div class="row ">
            <div class="col-xl-12 d-flex  px-5">
                <h3 class=" fw-bold"> طلبات التنفيذ</h3>
            </div>
            ...
            <div class="col-xl-2 col-sm-4   rounded-3 mx-3 " style="border:1px solid rgb(213, 212, 212);height:46.5px">
                <a href="{{ route('implementations.create') }}" class="text-dark text-decoration-none fw-bold">
                        ...
                        <div class="col-xl-10  col-sm-8 ">
                            <div class="row justify-content-center d-flex align-items-center" style="height: 45px">
                                <div class="col-xl-12 col-sm-10">
                                    <div class="fw-bold  text-center" style="font-size:18px;cursor: pointer;">إضافة طلب تنفيذ</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <livewire:affichage-implementation/>
            </div>
