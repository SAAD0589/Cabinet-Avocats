...
@section('title', 'Ajoute Annuaire Telephonique')
...
@section('content')
    ...
    <div class="container ">
        ...
        <div class="row d-flex justify-content-end">
            <form action="{{ route('AnnuaireTelephonique.store') }}" method="post" enctype="multipart/form-data">
                <div class="">
                    @csrf
                    <div class="row py-2 justify-content-center">
                        ...
                        {{ app()->getLocale() === 'ar' ? 'no-repeat 3%' : 'no-repeat 97%' }}  !important;"
                                ...
                                <option value="1">الموكلون</option>
